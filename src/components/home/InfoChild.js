...
const InfoChild = ({btnText, mainInfo}) => {
  return (
    <div className='my-6 px-5 flex flex-col-reverse'>
      <div className='flex flex-col justify-center'>
        <h3 className='my-4 text-center text-2xl font-bold'>{mainInfo}</h3>
        ...
        <button className="mx-auto m-7 px-5 py-2 rounded-sm border-2 border-yellow bg-yellow text-white font-bold duration-200 hover:bg-transparent hover:text-yellow">{btnText}</button>
      </div>
